      ...
      <div className="mx-auto flex h-[clamp(600px,calc(100svh-100px),700px)] w-full max-w-[1440px] flex-col px-5 pb-6 sm:px-8 lg:px-12">
        <div className="relative h-full flex-1">
          ...
          <motion.h1
            ...
            custom={0.1}
            variants={fadeUp}
            className="absolute left-[0%] top-[17%] z-10 w-[58%] text-center font-boldfat text-[clamp(4.4rem,10.5vw,10rem)] font-normal leading-[0.82] tracking-[-0.045em] text-white"
